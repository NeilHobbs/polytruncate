...
wrapper_intervention_site_after_truncation_selection_deployed = function(intervention.before.selection,
                                                                         female.fitness.cost,
                                                                         male.fitness.cost,
  ...
  response.insecticide.fitness = wrapper_breeders_equation_insecticide_fitness_truncation(trait.mean = intervention.before.selection,
