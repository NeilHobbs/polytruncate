...
#'
#' @description Makes insecticidal mixtures in a way that the is an overlap between each mixture. This
#' means that each insecticide can be paired with two insecticides.
#'
