...
can_insecticide_be_returned_to_arsenal = function(insecticide,
                                                  current.generation, 
  ...
  answer = ifelse(simulation.array["intervention", insecticide, current.generation] <= return.threshold, 
