...
indirect_cross_selection_truncation = function(genetic.correlation,
  ...
  direct.response.insecticide.fitness = wrapper_breeders_equation_insecticide_fitness_truncation(trait.mean = intervention.before.selection,
  ...
  indirect.selection = direct.response.insecticide.fitness * genetic.correlation
