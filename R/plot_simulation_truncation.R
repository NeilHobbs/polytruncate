...
plot_simulation_truncation = function(simulation.dataframe, #created from the get_simulation_dataframe() function
  ...
  simulation.dataframe = simulation.dataframe%>%
    dplyr::rowwise()%>%
    dplyr::mutate(bioassay.survival = convert_resistance_score_to_bioassay_survival(maximum.bioassay.survival.proportion = 1,
