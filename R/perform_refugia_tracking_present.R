perform_refugia_tracking_present = function(dispersal.rate,
  ...
  intervention.insecticide.differential = calculate_insecticide_selection_differential(current.resistance.intensity = current.intervention.intensity,
  ...
  intervention.response = response_to_insecticide_selection(insecticide.selection.differential = intervention.insecticide.differential,
                                                            fitness.selection.differential = intervention.fitness.differential,
                                                            heritability = heritability,
  ...
  intervention.post.selection = track_resistance_insecticide_response(current.resistance.intensity = current.intervention.intensity,
  ...
  next.generation.intensity = track_refugia_after_migration(number.intervention.to.refugia = mosquitoes.leaving.intervention,
