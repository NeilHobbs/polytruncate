...
wrapper_female_insecticide_selection_differential_truncation_mixtures = function(vector.length,
                                                                        standard.deviation,
  ...
  female.population.size.exposed.survivors = calculate_female_population_size_exposed_survivors_truncation(female.insecticide.exposure = female.insecticide.exposure,
                                                                                                           ...
                                                                                                           field.survival = field.survival)*survival.to.other.insecticide
