wrapper_breeders_equation_insecticide_fitness_truncation_mixtures = function(vector.length,
                                                                    standard.deviation,
  ...
  female.insecticide.selection.differential =  wrapper_female_insecticide_selection_differential_truncation_mixtures(vector.length = vector.length,
  ...
  male.insecticide.selection.differential = wrapper_male_insecticide_selection_differential_truncation_mixtures(vector.length = vector.length,
                                                                                                       standard.deviation = standard.deviation,
