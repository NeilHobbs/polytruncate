...
impact_of_decay_simulations_linear = function(dispersal,
                                       coverage,
                                       fitness.cost,
                                       exposure,
                                       heritability,
  ...
  for(v in 1:81){
    ...
    temp = get_simulation_dataframe_mixtures(simulation.array = run_simulation_truncation(number.of.insecticides = 2,
                                                                                          ...
                                                                                          threshold.generations = 30,#no decay, so this value does not matter
...
no_decay_comparisons_linear = function(dispersal,
                                coverage,
                                fitness.cost,
                                exposure,
                                heritability,
...
scenario.1 = impact_of_decay_simulations_linear(dispersal = 0.2,
                                         coverage = 0.7,
                                         fitness.cost = 0,
                                         exposure = 0.7,
                                         heritability = 0.2,
...
scenario.1.no.decay = no_decay_comparisons_linear(dispersal = 0.2,
                                           coverage = 0.7,
                                           fitness.cost = 0,
                                           exposure = 0.7,
                                           heritability = 0.2,
...
scenario.2 = impact_of_decay_simulations_linear(dispersal = 0.2,
                                         coverage = 0.7,
                                         fitness.cost = 0,
                                         exposure = 0.7,
                                         heritability = 0.2,
...
scenario.2.no.decay = no_decay_comparisons_linear(dispersal = 0.2,
                                           coverage = 0.7,
                                           fitness.cost = 0,
                                           exposure = 0.7,
                                           heritability = 0.2,
...
scenario.3 = impact_of_decay_simulations_linear(dispersal = 0.2,
                                         coverage = 0.7,
                                         fitness.cost = 0,
                                         exposure = 0.7,
...
scenario.3.no.decay = no_decay_comparisons_linear(dispersal = 0.2,
                                           coverage = 0.7,
                                           fitness.cost = 0,
                                           exposure = 0.7,
                                           heritability = c(0.15, 0.25),
...
S3.2 = impact_decay_plot(scenario.1,
                  scenario.1.no.decay,
                  graph.title = "Scenario 1: The Impact of Insecticide Decay (linear)")

S3.3 = impact_decay_plot(scenario.2,
                  scenario.2.no.decay,
                  graph.title = "Scenario 2: Mismatched Initial Resistance (linear)")

S3.4 = impact_decay_plot(scenario.3,
                  scenario.3.no.decay,
                  graph.title = "Scenario 3: Mismatched Heritability (linear)")


ggsave(plot = S3.2,
       filename = "impact_decay_scenario1_linear.jpeg",
       dpi = 600,
       scale = 5,
       height = 800,
       width = 1200,
...
ggsave(plot = S3.3,
       filename = "impact_decay_scenario2_linear.jpeg",
       dpi = 600,
       scale = 5,
       height = 800,
       width = 1200,
...
ggsave(plot = S3.4,
       filename = "impact_decay_scenario3_linear.jpeg",
       dpi = 600,
       scale = 5,
       height = 800,
       width = 1200,
