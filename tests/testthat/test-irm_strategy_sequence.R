...
sim.array["intervention", 1, 100] = 200
sim.array["intervention", 2, 100] = 200
sim.array["intervention", 3, 100] = 20
...
for(i in 1:length(test.values)){
  test_that("deployment vector is extended by correct amount", {
    expect_equal(length(irm_strategy_sequence(number.of.insecticides = 3,
...
sim.array["intervention", 1, 50] = 200
sim.array["intervention", 2, 50] = 200
sim.array["intervention", 3, 50] = 200
available.vector = c(1,3)
withdrawn.vector = c(2)
deployed.insecticide = rep(1, times = 100)
...
test_that("NA is produced when no  insecticides available",{
  expect_identical(is.na((irm_strategy_sequence(number.of.insecticides = 3,
...
sim.array["intervention", 1, 200] = 20
sim.array["intervention", 2, 200] = 20
sim.array["intervention", 3, 200] = 100
...
test_that("available vector is returned",{
  ...
  expect_equal(irm_strategy_sequence(number.of.insecticides = 3,
