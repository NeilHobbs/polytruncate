...
sim.array["intervention", 1, 1] = 200
sim.array["intervention", 2, 1] = 200
sim.array["intervention", 3, 1] = 200

available.vector = c(1,2,3)
withdrawn.vector = c()

test_that("gives the correct withdraw insecticide",{
  expect_equal(return_and_withdrawal_of_insecticides_from_arsenal(number.of.insecticides = 3,
...
return_and_withdrawal_of_insecticides_from_arsenal(number.of.insecticides = 3,
                                                   current.generation = 1,
                                                   withdrawal.threshold = 100,
                                                   return.threshold = 50,
                                                   simulation.array = sim.array,
...
test_that("gives correct available insecticide",{
  ...
  expect_equal(length(return_and_withdrawal_of_insecticides_from_arsenal(number.of.insecticides = 3,
                                                                         current.generation = 1,
                                                                         withdrawal.threshold = 100,
                                                                         return.threshold = 50,
                                                                         simulation.array = sim.array,
