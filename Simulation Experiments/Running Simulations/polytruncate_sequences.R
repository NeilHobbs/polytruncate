...
fina.sequence.df = cbind(parameter.space.df, sequence.truncation.df)


write.csv(fina.sequence.df, ".//sequence_truncation.csv")



ggplot(fina.sequence.df, aes(x=peak.resistance))+
  geom_histogram()+
